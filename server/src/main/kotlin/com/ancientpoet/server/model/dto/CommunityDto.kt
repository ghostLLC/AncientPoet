...
@Serializable data class PostResponse(val id: Long, val userId: Long, val userNickname: String?, val contentText: String?, val contentImageUrls: List<String>? = null, val sharedMessageIds: List<Long>? = null, val type: String, val repostOfId: Long? = null, val likeCount: Int, val commentCount: Int, val createdAt: String? = null, val isLiked: Boolean = false)
...
@Serializable data class CommentResponse(val id: Long, val postId: Long, val userId: Long, val userNickname: String?, val content: String, val replyToCommentId: Long? = null, val createdAt: String? = null)
